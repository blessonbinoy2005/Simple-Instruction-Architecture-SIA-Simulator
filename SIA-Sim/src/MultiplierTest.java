...
class MultiplierTest {
    ...
    @Test
    void multiply2() {
        Word32 word1 = new Word32();
        Word32 word2 = new Word32();
        Word32 result = new Word32();
        TestConverter.fromInt(10, word1);
        TestConverter.fromInt(12, word2);
        Multiplier.multiply(word1, word2, result);
        assertEquals(120, TestConverter.toInt(result));
    }
    ...
    void multiply3() {
        ...
        Word32 word2 = new Word32();
        Word32 result = new Word32();
        TestConverter.fromInt(5, word1);
        TestConverter.fromInt(5, word2);
        Multiplier.multiply(word1, word2, result);
        assertEquals(25, TestConverter.toInt(result));
    }
    ...
    void multiply4() {
        ...
        Word32 word2 = new Word32();
        Word32 result = new Word32();
        TestConverter.fromInt(6, word1);
        TestConverter.fromInt(6, word2);
        Multiplier.multiply(word1, word2, result);
        assertEquals(36, TestConverter.toInt(result));
    }
